...
<body>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-content">
                ...
                <div class="search-filter-container" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); border-radius: 16px; padding: 20px; margin-bottom: 20px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.08);">
                    <form method="GET" action="<?= base_url('admin/dokumen') ?>" style="display: flex; gap: 12px; align-items: center;">
                        <div style="flex: 1; position: relative;">
                            ...
                            <input 
                                ...
                                name="search" 
                                class="form-control" 
                                placeholder="Cari berdasarkan Judul, Deskripsi, File, Tags, Menu, atau Kategori..." 
                                value="<?= esc($search ?? '') ?>"
                        ...
                        <?php if (!empty($search)): ?>
                            <a href="<?= base_url('admin/dokumen') ?>" class="btn" style="background: #6c757d; color: white; padding: 12px 24px; border-radius: 12px; display: flex; align-items: center; gap: 8px; text-decoration: none; white-space: nowrap;">
    ...
    <script>
        ...
        // Highlight search results untuk DOKUMEN
        document.addEventListener('DOMContentLoaded', function() {
