...
<head>
    ...
    <style>
        ...
        .kategori-table th:nth-child(4) { width: 27%; }   /* Deskripsi */
        .kategori-table th:nth-child(5) { width: 14%; }   /* Jumlah Dokumen */
        .kategori-table th:nth-child(6) { width: 11%; }   /* Waktu Upload */
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-content">
                ...
                <div class="search-filter-container" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); border-radius: 16px; padding: 20px; margin-bottom: 20px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.08);">
                    <form method="GET" action="<?= base_url('admin/kategori') ?>" style="display: flex; gap: 12px; align-items: center;">
                        <div style="flex: 1; position: relative;">
                            ...
                            <input 
                                ...
                                name="search" 
                                class="form-control" 
                                placeholder="Cari berdasarkan Nama Kategori, Menu, atau Deskripsi..." 
                                value="<?= esc($search ?? '') ?>"
                        ...
                        <?php if (!empty($search)): ?>
                            <a href="<?= base_url('admin/kategori') ?>" class="btn" style="background: #6c757d; color: white; padding: 12px 24px; border-radius: 12px; display: flex; align-items: center; gap: 8px; text-decoration: none; white-space: nowrap;">
    ...
    <script>
        ...
        // Highlight search results untuk KATEGORI
        document.addEventListener('DOMContentLoaded', function() {
